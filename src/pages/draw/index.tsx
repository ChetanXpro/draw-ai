...
function draw() {
  ...
  return (
    <div className="w-full  flex items-center justify-center">
      <div className="flex  flex-col h-full justify-center  sm:w-[40rem] md:w-[40rem] lg:w-[40rem]  gap-10  items-center">
        ...
        <form
          className="  mt-6 px-10 w-full  flex flex-col justify-center items-center gap-8"
          action=""
